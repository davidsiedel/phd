...
%
%
% where $\Delta \, t$ is a time increment.
...
% The equilibrium of the solid $\BodyLagrange$ is characterized by the stationarity of the total incremental Lagragian
% $\LagrangianOperator{\BodyLagrange}{\text{tot}}$
% such that for any time increment $\Delta \, t > 0$, and any admissible displacement, damage and micromorphic damage fields $\DisplacementField, \DamageField$
